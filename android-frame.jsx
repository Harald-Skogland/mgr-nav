...
function AndroidStatusBar({ dark = false }) {
  ...
  return (
    <div className="dc-statusbar" style={{
...
function AndroidDevice({
  ...
  return (
    <div className="dc-device" style={{
      width, height, borderRadius: 18, overflow: 'hidden',
      background: dark ? '#1d1b20' : 'var(--ga-color-surface-page)',   // was MD_C.surface (#f4fbf8 mint)
